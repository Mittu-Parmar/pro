        ...
        <div class="container">
          <div class="row no-gutters">
              ...
              <div class="col-lg-6 px-5 pt-2">
                <h1 class="font-weight-bolt py-3">Register Hear</h1>
                  <form action="RegisterController" method="post">
                    ...
                    <div class="from-row">
                        <div class="col-lg-6">
                          <input type="password" name="repassword" placeholder="Re-Password" class="form-control my-2 p-2">
                        </div>
                      </div>
                    <div class="from-row">
                      <div class="col-lg-6">
                        <button type="submit" class="btn1 mb-3">Register</button>
                      </div>
                    </div> 
                    <p><% 
                    ...
                    <p>Alrady have an account <a href="index.jsp">Login</a></p>
                  </form>
              </div>
          </div>
        </div>
